...
import { TeamdojoPersonModule } from './person/person.module';
import { TeamdojoPersonSkillModule } from './person-skill/person-skill.module';
...
@NgModule({
    ...
    imports: [
        ...
        TeamdojoImageModule,
        TeamdojoPersonModule,
        TeamdojoPersonSkillModule,
