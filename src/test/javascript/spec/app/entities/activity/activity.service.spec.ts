...
import { IActivity, Activity, ActivityType } from 'app/shared/model/activity.model';
...
describe('Service Tests', () => {
    describe('Activity Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Activity(0, ActivityType.SKILL_COMPLETED, 'AAAAAAA', currentDate);
        });
