...
import { PersonSkillComponent } from 'app/entities/person-skill/person-skill.component';
    ...
    describe('PersonSkill Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PersonSkillComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.personSkills[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
