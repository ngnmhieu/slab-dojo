...
describe('Service Tests', () => {
    describe('PersonSkill Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PersonSkillService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/person-skills';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PersonSkill', () => {
                service.create(new PersonSkill(null)).subscribe(received => {
            ...
            it('should update a PersonSkill', () => {
                service.update(new PersonSkill(123)).subscribe(received => {
            ...
            it('should return a PersonSkill', () => {
